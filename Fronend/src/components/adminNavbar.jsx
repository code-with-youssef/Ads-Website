      ...
      <div className="flex flex-col gap-2 px-4 w-full">
        ...
        >
          ...
          >
            <path
              fillRule="evenodd"
              d="M6 2a2 2 0 00-2 2v12a2 2 0 002 2h8a2 2 0 002-2V4a2 2 0 00-2-2H6zm4 3a1 1 0 011 1v2h2a1 1 0 110 2h-2v2a1 1 0 11-2 0V10H7a1 1 0 110-2h2V6a1 1 0 011-1z"
              clipRule="evenodd"
            />
          </svg>
          Ads Requests
